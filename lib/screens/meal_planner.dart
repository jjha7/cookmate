          ...
          return Card(
            child: ExpansionTile(title: Text(d), children: [
              ...
              ...ids.map((id){
                ...
                return ListTile(
                  leading: Image.asset(r.image, width: 56, height: 56, fit: BoxFit.cover),
                  title: Text(r.title),
                  trailing: IconButton(icon: const Icon(Icons.delete_outline), onPressed: ()=> app.removeFromPlanner(d, r.id)),
