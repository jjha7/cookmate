    ...
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        SwitchListTile(
            ...
            onChanged: (v) =>
                app.setTheme(v ? ThemeMode.dark : ThemeMode.light)),
        ListTile(
            title: const Text("Use System Theme"),
            trailing: const Icon(Icons.chevron_right),
            onTap: () => app.setTheme(ThemeMode.system)),
        const Divider(),
        ListTile(
            title: const Text("Clear Data"),
            subtitle: const Text("Favorites and weekly planner"),
            trailing: const Icon(Icons.delete_outline),
            onTap: () => app.clearAll()),
        const SizedBox(height: 24),
        const Center(child: Text("CookMate • Custom Build")),
        const SizedBox(height: 24),
      ]),
